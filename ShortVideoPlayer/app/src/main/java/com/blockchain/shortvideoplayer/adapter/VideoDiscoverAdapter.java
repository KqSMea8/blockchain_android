 ...
 * 修改备注：
 */
public class VideoDiscoverAdapter extends BaseAdapter {

    private String TAG=VideoDiscoverAdapter.class.getSimpleName();
    private List<VideoBean> videoBeanList;
    private Context mContext;
    public VideoDiscoverAdapter(Context context, List<VideoBean> videoBeanList){
        mContext=context;
    ...
    public View getView(final int pos, View view, ViewGroup arg2) {
        ...
        final ViewHolder vh;
        if(view==null){
            view= LayoutInflater.from(mContext).inflate(R.layout.video_discover_item, null);
            vh=new ViewHolder();
...
//            Picasso.with(mContext).load(videoBean.getVideo_pic()).into(vh.iv_thumbnail);
            Picasso.with(mContext)
                    ...
                    .resize(UIUtils.dip2px(179),UIUtils.dip2px(240))
