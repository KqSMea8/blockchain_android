...
import com.blockchain.shortvideoplayer.activity.VideoPlayActivity1;
import com.blockchain.shortvideoplayer.activity.VideoPlayActivity4;
import com.blockchain.shortvideoplayer.adapter.VideoRecommendAdapter;
import com.blockchain.shortvideoplayer.adapter.VideoRecommendRecyclerAdapter;
...
import com.blockchain.shortvideoplayer.widget.pulltorefresh.BaseRefreshListener;
import com.blockchain.shortvideoplayer.widget.pulltorefresh.PullToRefreshLayout;
 ...
 * @更新内容: TODO
 */
public class TabRecommendPager2 extends ViewTabBasePager implements View.OnClickListener, ViewPager.OnPageChangeListener, WeChatPayCallback,SwipeRefreshLayout.OnRefreshListener {
...
//    private ViewPager viewpager;
    ...
    private static final String TAG = TabRecommendPager2.class.getSimpleName();

    private RecyclerView gv_videos;
...
//    private ViewPagerLayoutManager mLayoutManager;
    ...
    private VideoRecommendRecyclerAdapter recommendRecyclerAdapter;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case GETRECLISTSUCCESS:  //获取推荐列表成功
                    ...
                    LogUtils.e(TAG +",pageNO:"+pageNo+ "获取推荐列表成功：" + str1);
                            ...
                            if (videoBeans != null) {
                                if(pageNo == 1){
                                    ...
                                    if(videoBeanList.size()>0){
                                        recommendRecyclerAdapter.addDataAt(videoBeanList.size()-1,videoBeans);
                                    }else {
                                        recommendRecyclerAdapter.addDataAt(0,videoBeans);
                                    }
                                }


//                                videoRecommendAdapter = new VideoRecommendAdapter(mContext, videoBeanList);
...
//                                VerticalViewPagerAdapter pagerAdapter = new VerticalViewPagerAdapter(((BaseActivity)mContext).getSupportFragmentManager());
//                                vvpBackPlay.setVertical(true);
//                                vvpBackPlay.setOffscreenPageLimit(1);
//                                pagerAdapter.setUrlList(hotVideoList);
...
//                    }
    ...
    public TabRecommendPager2(Context context) {
        super(context);
    }
...
//            case R.id.ll_hot1:
//                switchTitle(1);
//                vvpBackPlay.setVisibility(View.VISIBLE);
//                gv_videos.setVisibility(View.GONE);
//                iv_video.setVisibility(View.GONE);

//                getRecommendHotList();
                Intent intent = new Intent(mContext, VideoPlayActivity4.class);
                intent.putExtra("videoListStr", gson.toJson(hotVideoList));
    ...
    protected View initView() {
        view = View.inflate(mContext,
                R.layout.fragment_recommend2, null);
        vvpBackPlay = view.findViewById(R.id.vvp_back_play);
...
//        });
    ...
    private void initMessage() {
        ...
        gv_videos.setLayoutManager(staggeredGridLayoutManager);
        //3.创建适配器
        recommendRecyclerAdapter = new VideoRecommendRecyclerAdapter(mContext, videoBeanList);
        //设置添加,移除item的动画,DefaultItemAnimator为默认的
        gv_videos.setItemAnimator(null);
        //4.设置适配器
        gv_videos.setAdapter(recommendRecyclerAdapter);
        gv_videos.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
        ...
        recommendRecyclerAdapter.setOnItemClickListener(new VideoRecommendRecyclerAdapter.OnRecyclerItemClickListener() {

            @Override
            public void onItemClick(View view, int position) {
                VideoBean videoBean1 = videoBeanList.get(position);
                Intent intent = new Intent(mContext, VideoPlayActivity1.class);
                intent.putExtra("video_id", videoBean1.getVideo_id());
                intent.putExtra("videoListStr", gson.toJson(videoBeanList));
...
//        getRecommendList();
    ...
    public void changeToRecommend() {
        switchTitle(0);
        vvpBackPlay.setVisibility(View.GONE);
...
//    }
    private void getRecommendList() {
        ...
        reqBody.put("pages_no", String.valueOf(pageNo));
        reqBody.put("perpage_number", String.valueOf(pageSize));
        loadingDialog.show();
        LogUtils.e(TAG + "推荐参数："+ reqBody.toString());
...
//            position = (position + selectPostion) % videoBeanList.size();
            ...
            ll_recommend1.setOnClickListener(TabRecommendPager2.this);
