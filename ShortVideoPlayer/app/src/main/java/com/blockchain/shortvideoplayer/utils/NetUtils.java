...
public class NetUtils {
     ...
     * @return
     */
    public  void getDataAsynFromNetByParams(String url,Map<String, String> reqBody, final MyNetCall myNetCall) {
...
//            System.out.println("Key = " + entry.getKey() + ", Value = " + entry.getValue());
     ...
     *
     */
    public void uploadFile(String url, File file, String fileName,String fileParam, Map<String,String>
        ...
        //文件...参数fileParam指的是请求路径中所接受的参数...如果路径接收参数键值是fileeeee,
//此处应该改变
        builder.addFormDataPart(fileParam,fileName,RequestBody.create
