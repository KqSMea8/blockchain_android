package com.blockchain.vodplayerview.view.control;
...
import com.blockchain.vodplayerview.utils.TimeFormater;
import com.blockchain.vodplayerview.view.interfaces.ViewAction;
import com.blockchain.vodplayerview.view.quality.QualityItem;
...
//全屏下的切换分辨率按钮监听
    ...
    private static final int DELAY_TIME = 0; //5秒后隐藏
