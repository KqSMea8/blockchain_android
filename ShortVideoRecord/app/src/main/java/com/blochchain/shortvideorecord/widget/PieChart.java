package com.blochchain.shortvideorecord.widget;
...
import com.blochchain.shortvideorecord.utils.CalculateUtil;
...
//            canvas.drawArc(mRectF,startAngle,sweepAngle,true,mPaint);
            ...
            LogUtils.e("startAngle:"+startAngle+",name:"+name+",resToRound:"+resToRound + ",v:"+v);
            if (startAngle % 360.0 >= 90.0 && startAngle % 360.0 <= 270.0) {//2 3 象限
//                canvas.drawLine(pxt,pyt,pxt-30,pyt,mLinePaint);
                LogUtils.e("startAngle000000000000000000000");
                canvas.drawText(name+" "+resToRound+"%",pxt-mTextPaint.measureText(name+" "+resToRound+"%"),pyt+30,mTextPaint);
            } if(startAngle == 360.0 ){
                LogUtils.e("startAngle11111111111111111111111111111");
                canvas.drawText(name+" "+resToRound+"%",pxt-mTextPaint.measureText(name+" "+resToRound+"%"),pyt+30,mTextPaint);
            }
            else {
                LogUtils.e("startAngle2222222222222222222222222222");
//                canvas.drawLine(pxt,pyt,pxt+30,pyt,mLinePaint);
                canvas.drawText(name+" "+resToRound+"%",pxt,pyt-20,mTextPaint);
            }
        }
